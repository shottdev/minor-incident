...
function draw_sprite_outline_shadow(_sprite, _subimg, _x, _y, _thickness, _offsetx, _offsety, _out_color = c_black, _shadow_color = c_black)
{
	var _col = draw_get_colour();
	
	draw_set_colour(_shadow_color);
	
	draw_sprite(_sprite, _subimg, _x + _offsetx, _y + _offsety);
	
	draw_set_colour(_col);
	
	draw_sprite_outline(_sprite, _subimg, _x, _y, _thickness, _out_color);
}